...
import io.walter.manager.AddServiceActivity;
import io.walter.manager.R;
import io.walter.manager.adapters.ServicesListAdapter;
...
public class ServicesFragment extends Fragment {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.menu_add_stock) {
            Intent x =new Intent(getActivity(), AddServiceActivity.class);
            startActivity(x);
        }
        return true;
    }
